...
import com.inovel.entity.LoginResponse;
import com.inovel.entity.User;
import com.inovel.mapper.UserMapper;
...
public class UserService {
    ...
    // 注册
    public Result<Long> register(String phone, String password) {
    ...
    public Result<LoginResponse> login(String phone, String password) {
        ...
        LoginResponse response = new LoginResponse(token, user.getId(), user.getNickname(), user.getPhone(),
                user.getAvatar());
